...
const plans = [
  {
    ...
    dbId: 1,
    price: { ru: '0', en: '0' },
    features: ['1', '100 Mbps', '3 GB/мес', t => t('tariffs.no_logs')],
    featuresEn: ['1', '100 Mbps', '3 GB/mo', t => t('tariffs.no_logs')],
    popular: false,
  },
  {
    key: 'pro',
    ...
    features: ['5', '950 Mbps', t => t('tariffs.unlimited'), t => t('tariffs.no_logs'), t => t('tariffs.kill_switch'), t => t('tariffs.priority_support')],
    featuresEn: ['5', '950 Mbps', t => t('tariffs.unlimited'), t => t('tariffs.no_logs'), t => t('tariffs.kill_switch'), t => t('tariffs.priority_support')],
    popular: true,
  },
  {
    key: 'business',
    ...
    features: ['10', '950 Mbps', t => t('tariffs.unlimited'), t => t('tariffs.no_logs'), t => t('tariffs.kill_switch'), t => t('tariffs.dedicated_ip'), t => t('tariffs.support_247')],
    featuresEn: ['10', '950 Mbps', t => t('tariffs.unlimited'), t => t('tariffs.no_logs'), t => t('tariffs.kill_switch'), t => t('tariffs.dedicated_ip'), t => t('tariffs.support_247')],
    popular: false,
  },
]
